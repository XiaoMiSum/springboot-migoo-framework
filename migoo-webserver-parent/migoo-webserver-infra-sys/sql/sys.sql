...
VALUES (1, '系统管理', 'system:manager', 1, 9998, 0, '/system', 'ep:setting', NULL, '', 1, 1, 0, 1, 0, '',
        '2022-04-29 18:34:52', '超级管理员', '2023-09-27 22:48:18');
INSERT INTO `sys_menu`
VALUES (3, '工作台', 'dashboard', 2, 0, 0, '', 'ep:alarm-clock', 'Dashboard', 'dashboard/index', 1, 1, 1, 1, 0, '',
        NULL, '超级管理员', '2023-09-27 22:37:53');
INSERT INTO `sys_menu`
VALUES (100, '用户管理', 'system:user:query', 2, 0, 1, 'user', 'ep:user', 'SystemUser', 'system/user/index', 1, 1, 1, 1,
        0, '', '2022-04-29 18:45:02', '超级管理员', '2023-09-27 22:48:39');
INSERT INTO `sys_menu`
VALUES (101, '角色管理', 'system:role:query', 2, 1, 1, 'role', 'fa-solid:user-plus', 'UserRole', 'system/role/index', 1,
        1, 1, 1, 0, '', '2022-04-29 18:45:02', '超级管理员', '2023-09-27 22:49:31');
INSERT INTO `sys_menu`
VALUES (102, '部门管理', 'system:dept:query', 2, 2, 1, 'dept', 'ep:basketball', 'SystemDept', 'system/dept/index', 1, 1,
        1, 1, 0, '', '2022-04-29 18:45:02', '超级管理员', '2023-09-27 22:50:05');
INSERT INTO `sys_menu`
VALUES (103, '岗位管理', 'system:post:query', 2, 3, 1, 'post', 'ep:postcard', 'SystemPost', 'system/post/index', 1, 1,
        1, 1, 0, '', '2022-04-29 18:45:02', '超级管理员', '2023-09-27 22:50:32');
INSERT INTO `sys_menu`
VALUES (104, '菜单管理', 'system:menu:query', 2, 4, 1, 'menu', 'ep:menu', 'SystemMenu', 'system/menu/index', 1, 1, 1, 1,
        0, '', '2022-04-29 18:45:02', '超级管理员', '2023-09-27 22:50:53');
INSERT INTO `sys_menu`
VALUES (106, '主题设置', 'layout:setting', 3, 0, 3, '', '', NULL, '', 1, 1, 0, 1, 0, '超级管理员',
        '2023-07-23 18:56:46', '超级管理员', '2024-04-14 12:58:34');
INSERT INTO `sys_menu`
VALUES (105, '配置管理', 'system:configurer:query', 2, 99999, 1, 'configurer', 'ep:guide', 'SystemConfig',
        'system/configurer/index', 1, 1, 1, 1, 0, '超级管理员', '2023-05-18 14:45:15', '超级管理员',
        '2024-04-14 12:58:30');
INSERT INTO `sys_menu`
VALUES (111, '新增', 'system:user:add', 3, 0, 100, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1', '2022-05-01 13:55:34',
        '奥丁1', '2024-04-14 12:57:29');
INSERT INTO `sys_menu`
VALUES (112, '修改', 'system:user:update', 3, 1, 100, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1', '2022-05-01 13:55:59',
        '超级管理员', '2024-04-14 12:57:28');
INSERT INTO `sys_menu`
VALUES (113, '删除', 'system:user:remove', 3, 3, 100, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1', '2022-05-01 13:56:20',
        '奥丁1', '2024-04-14 12:57:27');
INSERT INTO `sys_menu`
VALUES (114, '重置密码', 'system:user:reset-password', 3, 4, 100, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1',
        '2022-05-01 14:00:56', '奥丁1', '2024-04-14 12:57:26');
INSERT INTO `sys_menu`
VALUES (115, '重置验证器', 'system:user:reset-authenticator', 3, 0, 100, '', '', NULL, '', 1, 1, 0, 1, 0, '超级管理员',
        '2023-05-18 14:45:35', '超级管理员', '2024-04-14 13:00:42');
INSERT INTO `sys_menu`
VALUES (116, '分配角色', 'system:permission:assign-user-role', 3, 4, 100, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1',
        '2022-05-01 16:05:28', '奥丁1', '2024-04-14 12:57:24');
INSERT INTO `sys_menu`
VALUES (117, '新增', 'system:role:add', 3, 0, 101, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1', '2022-05-01 16:00:30',
        '奥丁1', '2024-04-14 12:57:23');
INSERT INTO `sys_menu`
VALUES (118, '修改', 'system:role:update', 3, 1, 101, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1', '2022-05-01 16:01:01',
        '超级管理员', '2024-04-14 12:57:22');
INSERT INTO `sys_menu`
VALUES (119, '删除', 'system:role:remove', 3, 2, 101, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1', '2022-05-01 16:01:24',
        '奥丁1', '2024-04-14 12:57:21');
INSERT INTO `sys_menu`
VALUES (120, '分配菜单', 'system:permission:assign-role-menu', 3, 3, 101, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1',
        '2022-05-01 16:06:41', '奥丁1', '2024-04-14 12:57:20');
INSERT INTO `sys_menu`
VALUES (121, '新增', 'system:dept:add', 3, 0, 102, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1', '2022-05-01 16:07:56',
        '奥丁1', '2024-04-14 12:57:18');
INSERT INTO `sys_menu`
VALUES (122, '修改', 'system:dept:update', 3, 1, 102, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1', '2022-05-01 16:08:12',
        '超级管理员', '2024-04-14 12:57:17');
INSERT INTO `sys_menu`
VALUES (123, '删除', 'system:dept:remove', 3, 3, 102, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1', '2022-05-01 16:08:24',
        '奥丁1', '2024-04-14 12:57:16');
INSERT INTO `sys_menu`
VALUES (124, '新增', 'system:post:add', 3, 0, 103, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1', '2022-05-01 16:15:22',
        '奥丁1', '2024-04-14 12:57:15');
INSERT INTO `sys_menu`
VALUES (125, '修改', 'system:post:update', 3, 1, 103, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1', '2022-05-01 16:18:11',
        '超级管理员', '2024-04-14 12:57:14');
INSERT INTO `sys_menu`
VALUES (126, '删除', 'system:post:remove', 3, 2, 103, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1', '2022-05-01 16:18:28',
        '奥丁1', '2024-04-14 12:57:01');
INSERT INTO `sys_menu`
VALUES (127, '新增', 'system:menu:add', 3, 0, 104, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1', '2022-05-01 16:19:11',
        '奥丁1', '2024-04-14 12:56:59');
INSERT INTO `sys_menu`
VALUES (128, '修改', 'system:menu:update', 3, 1, 104, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1', '2022-05-01 16:19:42',
        '超级管理员', '2024-04-14 12:56:57');
INSERT INTO `sys_menu`
VALUES (129, '删除', 'system:menu:remove', 3, 2, 104, '', '', NULL, '', 1, 1, 0, 1, 0, '奥丁1', '2022-05-01 16:19:56',
        '奥丁1', '2024-04-14 12:56:56');
INSERT INTO `sys_menu`
VALUES (130, '修改', 'system:configurer:update', 3, 0, 105, '', '', NULL, '', 1, 1, 0, 1, 0, '超级管理员',
        '2023-05-18 14:45:35', '超级管理员', '2024-04-14 13:00:42');
...
(
    ...
    `label`       varchar(64)   NOT NULL COMMENT '页面显示名称',
    `value`       varchar(2048) NOT NULL COMMENT '属性值',
    `options`     text          NULL DEFAULT NULL COMMENT '操作选项',
