...
import xyz.migoo.framework.common.util.object.ObjectUtils;
import xyz.migoo.framework.infra.Area;
import xyz.migoo.framework.infra.enums.AreaTypeEnum;
...
public class AreaUtils {
    ...
    public static Area parseArea(String pathStr) {
        ...
        for (String path : paths) {
            if (area == null) {
                area = CollectionUtils.findFirst(areas.values().stream().toList(), item -> item.getName().equals(path));
            } else {
