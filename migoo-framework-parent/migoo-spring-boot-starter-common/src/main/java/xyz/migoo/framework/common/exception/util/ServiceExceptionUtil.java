package xyz.migoo.framework.common.exception.util;
...
public class ServiceExceptionUtil {
     ...
     * @return 异常
     */
    public static ServiceException get(Integer code) {
        return get0(code, MESSAGES.get(code));
    }
     ...
     * @return 异常
     */
    public static ServiceException get(Integer code, Object... params) {
        return get0(code, MESSAGES.get(code), params);
    }

    public static ServiceException get0(Integer code, String messagePattern, Object... params) {
