...
class IntegerListTypeHandlerTest {
    ...
    private final IntegerListTypeHandler handler = new IntegerListTypeHandler();

    @Test
    void setParameterJoinsWithComma() throws Exception {
        PreparedStatement ps = mock(PreparedStatement.class);

        handler.setParameter(ps, 1, Arrays.asList(1, 2, 3), JdbcType.VARCHAR);
    ...
    void getResultParsesCommaSeparatedValue() throws Exception {
        ...
        assertThat(handler.getResult(rs, "ids")).containsExactly(1, 2, 3);
    }
