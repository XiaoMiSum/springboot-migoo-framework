package xyz.migoo.framework.ai.core.factory;
...
import xyz.migoo.framework.ai.config.MiGooAiAutoConfiguration;
import xyz.migoo.framework.ai.config.MiGooAiProperties;
import xyz.migoo.framework.ai.core.enums.AiPlatformEnum;
...
import xyz.migoo.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
...
import static xyz.migoo.framework.common.util.collection.CollectionUtils.convertList;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    /**
     * 可参考 {@link MiGooAiAutoConfiguration#deepSeekChatModel(MiGooAiProperties)}
     */
    private static DeepSeekChatModel buildDeepSeekChatModel(String apiKey) {
        MiGooAiProperties.DeepSeekProperties properties = new MiGooAiProperties.DeepSeekProperties()
                .setApiKey(apiKey);
        return new MiGooAiAutoConfiguration().buildDeepSeekChatModel(properties);
    }

    /**
     * 可参考 {@link MiGooAiAutoConfiguration#xingHuoChatClient(MiGooAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        MiGooAiProperties.XingHuoProperties properties = new MiGooAiProperties.XingHuoProperties()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new MiGooAiAutoConfiguration().buildXingHuoChatClient(properties);
    }
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            MiGooAiProperties.MidjourneyProperties properties = SpringUtil.getBean(MiGooAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link MiGooAiAutoConfiguration#douBaoChatClient(MiGooAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        MiGooAiProperties.DouBaoProperties properties = new MiGooAiProperties.DouBaoProperties()
                .setApiKey(apiKey);
    ...
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        MiGooAiProperties.HunYuanProperties properties = new MiGooAiProperties.HunYuanProperties()
                .setBaseUrl(url).setApiKey(apiKey);
        return new MiGooAiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link MiGooAiAutoConfiguration#siliconFlowChatClient(MiGooAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        MiGooAiProperties.SiliconFlowProperties properties = new MiGooAiProperties.SiliconFlowProperties()
                .setApiKey(apiKey);
        return new MiGooAiAutoConfiguration().buildSiliconFlowChatClient(properties);
    }
    ...
    /**
     * 可参考 {@link MiGooAiAutoConfiguration#baiChuanChatClient(MiGooAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        MiGooAiProperties.BaiChuanProperties properties = new MiGooAiProperties.BaiChuanProperties()
                .setApiKey(apiKey);
        return new MiGooAiAutoConfiguration().buildBaiChuanChatClient(properties);
    }
