...
public abstract class AbstractSmsClient implements SmsClient {
    ...
    @Override
    public SmsResult<SmsTemplateRespDTO> getSmsTemplate(String apiTemplateId) throws Throwable {
        // 执行短信发送
        return doGetSmsTemplate(apiTemplateId);
    }

    protected abstract SmsResult<SmsTemplateRespDTO> doGetSmsTemplate(String apiTemplateId) throws Throwable;
